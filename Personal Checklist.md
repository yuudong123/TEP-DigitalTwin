...
**완료 기준**
- [ ] 프로젝트가 무엇을 만들고 왜 만드는지 한 문장으로 설명 가능
...
- [ ] TEP 데이터셋 공식 문서 정리
- [ ] 8개 CSV 파일의 역할 확인
- [ ] 각 `Id`가 하나의 독립 Run-to-Failure trajectory임을 문서화
- [ ] `Time` 단위 및 3분 샘플링 간격 확인
- [ ] 전체 변수 목록 정리
- [ ] 변수 역할 분류
  - [ ] 측정 센서
  - [ ] 조작 변수
...
- [ ] 운전 모드 의미 확인
- [ ] 열화 시나리오 의미 확인
- [ ] case 파일과 열화/운전조건의 관계 확인
- [ ] 데이터 누수 가능성이 있는 변수 후보 정리
- [ ] EOL 정의 확정
- [ ] RUL 계산식 확정

**완료 기준**
- [ ] 각 주요 컬럼이 무엇을 의미하는지 설명 가능
- [ ] 모델에 넣어도 되는 변수와 제외할 변수가 구분됨
...
- [ ] 과거 30분 feature
- [ ] 과거 60분 feature
- [ ] 미래 데이터가 feature에 섞이지 않는지 검사
- [ ] 시계열 feature 모델 학습
- [ ] Baseline과 성능 비교
- [ ] 복잡도 대비 성능 향상 판단

**완료 기준**
- [ ] 시계열 feature 사용 여부를 성능 근거로 결정
...
- [ ] 모델 버전 정보 저장
- [ ] feature 목록 저장
- [ ] SHAP 또는 feature importance 구현
- [ ] 주요 위험 요인 출력 형식 정의
- [ ] 예측 결과 schema 정의

**완료 기준**
- [ ] 한 입력에 대해 RUL, 위험도, 상태, 주요 원인을 함께 출력 가능
